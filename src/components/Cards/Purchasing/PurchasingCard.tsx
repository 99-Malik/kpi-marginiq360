...
export type Order = {
    id: string;
    vendor: string;
    status: 'Order Sent' | 'Delivered' | 'Confirmed' | 'Issued';
    theme: 'gray' | 'green' | 'blue' | 'yellow';
    expected?: string;
    items?: number | string;
    total?: string;
...
const THEME = {
    ...
    blue: {
        border: 'border-[#B0DEDF]', 
        badge: 'bg-[#E6F4F5] border-[#009499] text-[#009499] font-semibold',
        iconWrap: 'bg-white',
        icon: (
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function PurchaseCard({ order, onCardClick }: { order: Order; onCardClick: (order: Order) => void }) {
