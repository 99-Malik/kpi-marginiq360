        ...
        >
             ...
             <div className="flex items-center gap-2 mb-1">
                ...
                <div className="flex items-start justify-between mt-3">
                    {/* Value on the left with conditional prefix/suffix */}
                    <div className="text-2xl font-semibold text-gray-900 flex-shrink-0 flex items-center gap-0">
                        ...
                        {(title === "Total Revenue" || title === "Gross Profit") && (
                        ...
                        {value}
                        {/* Percentage sign for Avg Margin */}
                        {title === "Avg Margin" && (
                            <span className="text-2xl font-semibold text-gray-900">%</span>
                        )}
                    </div>
                    
                    {/* Chart on the right - always takes up space */}
              ...
              {/* Amount and change below in full length */}
              <div className="text-sm font-medium flex items-center gap-1 mt-1" style={{ color: text }}>
                 {change}
                 ...
                 {hasAmount ? (
                     ...
                     <svg width="12" height="2" viewBox="0 0 12 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                         <path d="M0.036 1.738V0.758H4.936V1.738H0.036ZM7.07866 1.738V0.758H11.9787V1.738H7.07866Z" fill="#727A90" />
                     </svg>
                 )}
             </div>
        </div>
