...
type MenuModalProps = {
  ...
  export default function MenuModal({
                    ...
                    <div>
                        ...
                        <div className="px-4 ">
                            <div className="flex items-center justify-between">
                                <h2 className="text-md font-semibold text-gray-900">Create New Menu Item</h2>
    ...
    ${currentStep === 0 ? 'px-8 sm:px-12' :
                                    currentStep === 1 ? 'px-8 sm:px-32' :
                                        currentStep === 2 ? 'px-6 sm:px-10' :
                                            'px-8 sm:px-12'
                                }`}
                        >                            {/* Row 1: Icons + Lines */}
                            <div className="grid items-center grid-cols-[40px_1fr_40px_1fr_40px_1fr_40px] gap-0">
                            ...
                            <div className="grid mt-2 grid-cols-[40px_1fr_40px_1fr_40px_1fr_40px] gap-0">
                                {steps.map((step, index) => (
                                    <React.Fragment key={step}>
                            ...
                            <>
                                ...
                                <div className="space-y-6 px-4 mt-4">
                                    ...
                                    <div className="w-full flex gap-4 items-stretch">
                                        {/* Left column */}
                                        <div className="basis-1/2 shrink-0 pr-4">
                                            <div className="flex items-end gap-4 w-full">
                                                ...
                                                <div className="flex-1 min-w-[120px]">
                                                    ...
                                                    <ProductDropdown
                                                        options={['Chicken', 'Beef', 'Fish', 'Eggs']}
                                                ...
                                                <div className="flex-1 min-w-[240px]">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div className="flex h-10 items-stretch border border-gray-200 rounded-lg overflow-hidden">
                                                            {/* Unit Selector */}
                                                            ...
                                                            <div className="flex items-center px-5">
                                                                <button type="button" onClick={dec} className="h-6 w-6">
                                                                    {/* Minus Icon */}
                      ...
                      [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                                                ...
                                                                <button type="button" onClick={inc} className="h-6 w-6">
                                                                    {/* Plus Icon */}
                                                                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none">
                                                                        <rect x="0.5" y="0.574463" width="20" height="20" rx="4" fill="#F8F8FC" />
                                                        ...
                                                        >
                                                            ...
                                                            <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M13.9997 3.24088H11.933C11.614 1.68994 10.2497 0.576219 8.66632 0.574219H7.33298C5.74957 0.576219 4.38526 1.68994 4.06632 3.24088H1.99966C1.63148 3.24088 1.33301 3.53934 1.33301 3.90753C1.33301 4.27572 1.63148 4.57422 1.99966 4.57422H2.66632V13.2409C2.66854 15.0809 4.15963 16.572 5.99966 16.5742H9.99966C11.8397 16.572 13.3308 15.0809 13.333 13.2409V4.57422H13.9997C14.3679 4.57422 14.6663 4.27575 14.6663 3.90756C14.6663 3.53938 14.3679 3.24088 13.9997 3.24088Z" fill="#E51B1B" />
                                                            </svg>
                                                        </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="flex mt-4">
                                                <button className="ml-auto rounded-xl border border-primary text-primary px-4 py-2 text-sm font-medium hover:bg-primary/5 whitespace-nowrap">
                                                    Add Recipie
                                                </button>
                                            </div>
                                        </div>

                                        {/* Right column (Amber) with vertical divider */}
                                        <div className="basis-1/2 shrink-0 min-h-[180px]  border-l border-gray-300 pl-4 rounded-r-lg" >
                                            <div className="basis-1/2 shrink-0 pr-4">
                                                <div className="flex items-end gap-4 w-full">
                                                    {/* Choose Item */}
                                                    <div className="flex-1 min-w-[120px]">
                      ...
                      [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                                            ...
                                            <div className="basis-1/2 shrink-0 pr-4 mt-4">
                                                <div className="flex items-end gap-4 w-full">
                                                    {/* Choose Item */}
                                                    <div className="flex-1 min-w-[120px]">
                                                        <label className="block mb-2 text-sm font-medium text-gray-700">
                                                        ...
                                                        <ProductDropdown
                                                            options={['Chicken', 'Beef', 'Fish', 'Eggs']} onChange={(v) => console.log(v)}
                                                        />
                                                    </div>
