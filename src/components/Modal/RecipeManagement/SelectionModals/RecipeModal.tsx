                    ...
                    <div>
                        ...
                        <div className="px-4 ">
                            <div className="flex items-center justify-between">
                                <h2 className="text-md font-semibold text-gray-900">Create New Recipe</h2>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {instructionSteps.map((step, index) => (
                                            <React.Fragment key={step.id}>
                                                ...
                                                <div 
                                                    key={step.id} 
                                                    className={`flex items-center flex-nowrap py-1 transition-all duration-200 ${
                                                        dragOverStep === step.id ? 'bg-blue-50 border-2 border-blue-200 rounded-lg' : ''
