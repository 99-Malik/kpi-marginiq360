...
interface IssueReportedSuccessFullyModalProps {
    isOpen: boolean;
    onClose: () => void;
}

const IssueReportedSuccessFully: React.FC<IssueReportedSuccessFullyModalProps> = ({ isOpen, onClose }) => {
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40" onClick={onClose}>
            ...
            >
                ...
                <h2 className="text-xl font-bold text-gray-900 mb-4">
                    Your Report Issue has been successfully submitted to vendor
                </h2>
...
export default IssueReportedSuccessFully;
