...
interface NewBorrowOrderModalProps {
    isOpen: boolean;
    onClose: () => void;
    onOrderSubmit?: () => void;
}
...
const NewBorrowOrderModal: React.FC<NewBorrowOrderModalProps> = ({ isOpen, onClose, onOrderSubmit }) => {
        ...
        <div className="fixed inset-0 bg-black/40 z-[10000] flex items-center justify-center">
            ...
            >
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-gray-200">
                    <h2 className="text-lg font-semibold text-gray-900">Borrow New Items</h2>
                    <button
                        onClick={onClose}
...
export default NewBorrowOrderModal;