...
interface OrderRequestSubmitted {
    isOpen: boolean;
    onClose: () => void;
}

const OrderRequestSubmitted: React.FC<OrderRequestSubmitted> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/40" onClick={onClose}>
            ...
            >
                ...
                Your Order Request Submitted Successfully!  
                </h2>
...
export default OrderRequestSubmitted;
