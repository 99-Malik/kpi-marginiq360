...
interface VendorUpdatedModal {
    isOpen: boolean;
    onClose: () => void;
    message?: string;
}

const VendorUpdatedModal: React.FC<VendorUpdatedModal> = ({ isOpen, onClose, message = "Vendor updated successfully!" }) => {
...
export default VendorUpdatedModal;
