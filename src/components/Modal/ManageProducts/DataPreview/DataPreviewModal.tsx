...
const DataPreviewModal: React.FC<DataPreviewModalProps> = ({
    ...
    const [columns, setColumns] = useState<ColumnData[]>([
        { id: '1', name: 'Ingredient Name', example: '(e.g, Bun)', action: 'keep' },
        { id: '2', name: 'Category', example: '(e.g, Supplies)', action: 'keep' },
        { id: '3', name: 'Price', example: '(e.g,$45)', action: 'keep' },
        { id: '4', name: 'Supplier', example: '(e.g, Syco Food Ltd)', action: 'keep' },
        { id: '5', name: 'Unit Cost', example: '(e.g,$20)', action: 'discard' },
    ]);
