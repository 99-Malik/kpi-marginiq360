...
function Pagination() {
    ...
    // Updated data structure to match the image with ingredient items
    const inventoryData = [
        {
            id: '1',
            ingredientName: 'Bun',
        ...
        },
        {
            ...
            category: 'Supplies',
            price: '$32',
            supplier: 'Savory Solutions Group',
            unitCost: '$35',
            udm: 'Depot D',
            packSize: '30/Pack',
            lastUpdate: 'Today'
        },
        {
            ...
            category: 'Vegetables',
            price: '$85',
            supplier: 'Epicurean Essentials Ltd',
            unitCost: '$30',
            udm: 'Depot B',
            packSize: '10/Pack',
            lastUpdate: 'Yesterday'
        ...
        },
        {
            ...
            category: 'Meat',
            price: '$150',
            supplier: 'Culinary Creations Co.',
            unitCost: '$25',
            udm: 'Depot E',
            packSize: '200/Pack',
        ...
        },
        {
            id: '7',
            ingredientName: 'Bun',
            category: 'Vegetarian Opti...',
            price: '$90',
            supplier: 'Gourmet Delights Inc',
            unitCost: '$20',
            udm: 'Depot A',
            packSize: '50/Pack',
            lastUpdate: '#15616'
            ...
            <div className="bg-white rounded-2xl border border-[#E9EAEA]">
                ...
                <div className="flex justify-between items-center p-4 border-b border-gray-200">
                    ...
                    <div className="min-w-0">
                        <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Items</h1>
                ...
                <div className="bg-white overflow-x-auto custom-Horizontalscroll pb-8">
                    ...
                    <table className="w-full min-w-[1000px] text-sm text-left whitespace-nowrap">
                        <thead className="bg-white text-xs  text-gray-500 font-normal tracking-wider">
                            <tr>
                                {/* Column Headers */}
                                {['Ingredient Name', 'Category', 'Price', 'Supplier', 'Unit Cost', 'UDM', 'Pack Size', 'Last Update'].map((header) => (
                        ...
                        <tbody>
                            {paginatedData.map((item, i) => (
                                ...
                                >
                                    <td className="px-4 py-6">{item.ingredientName}</td>
                                    <td className="px-4 py-6 text-[#686F83]">{item.category}</td>
                                    <td className="px-4 py-6 text-[#686F83]">{item.price}</td>
                                    <td className="px-4 py-6 ]">{item.supplier}</td>
                                    <td className="px-4 py-6">{item.unitCost}</td>
                                    <td className="px-4 py-6">{item.udm}</td>
                                    <td className="px-4 py-6">{item.packSize}</td>
                                    <td className="px-4 py-6">{item.lastUpdate}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
