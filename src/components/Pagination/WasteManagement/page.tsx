...
function Pagination() {
    ...
    // Updated data structure to match the waste items table
    const inventoryData = [
        {
            id: '1',
            product: 'Ground Beef',
            ...
            <div className="bg-white rounded-2xl border border-[#E9EAEA]">
                ...
                <div className="flex justify-between items-center p-4 border-b border-gray-200">
                    ...
                    <div className="min-w-0">
                        <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Top Waste Items</h1>
                        <p className="text-gray-500 mt-2 text-sm">
                            You can manage the top waste items here
                        </p>
                    </div>
                ...
                <div className="bg-white overflow-x-auto custom-Horizontalscroll pb-8">
                    ...
                    <table className="w-full min-w-[1000px] text-sm text-left whitespace-nowrap">
                        <thead className="bg-white text-xs  text-gray-500 font-normal tracking-wider">
                            <tr>
                                {/* Column Headers */}
                                {['Product', 'Category', 'Cost', 'Total Quantity', 'Dated', 'Occurrences'].map((header) => (
                        ...
                        <tbody>
                            {paginatedData.map((item, i) => (
                                ...
                                >
                                    <td className="px-4 py-6">{item.product}</td>
                                    <td className="px-4 py-6 text-[#686F83]">{item.category}</td>
                                    <td className="px-4 py-6 text-[#E51B1B]">{item.cost}</td>
                                    <td className="px-4 py-6">{item.totalQuantity}</td>
                                    <td className="px-4 py-6">{item.dated}</td>
                                    <td className="px-4 py-6">{item.occurrences}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
